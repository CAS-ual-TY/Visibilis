...
public interface IPrintEntity extends IPrintHolder
{
    /**
    ...
    public default boolean openGui(PlayerEntity player)
    {
        ...
        if(player.world == world)
        {
            ...
            {
                Visibilis.channel.send(PacketDistributor.PLAYER.with(() -> (ServerPlayerEntity)player), new SynchEntityToClientMessage(this, this.synchVariables(), true));
                return true;
            }
        }
    ...
    {
        return new EntityPrintProvider(this.getNodeList(), (Entity)this);
    }
    ...
    {
        return IPrintEntity.getDataFactory((Entity)this);
    }
    ...
    {
        Visibilis.channel.send(PacketDistributor.TRACKING_ENTITY.with(() -> (Entity)this), new SynchEntityToClientMessage(this, this.synchVariables(), false));
    }
