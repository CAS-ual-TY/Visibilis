...
public class VConfigClient
{
    ...
    public VConfigClient(Builder builder)
    {
        ...
        this.list.add(VConfigUtility.buildColorConfigValue(builder, Visibilis.MOD_ID, "vector3d", () -> VDataTypes.VECTOR3D, new float[] { 1F, 0.75F, 0.75F }, VUtility.COLOR_DEFAULT_BLACK));
        this.list.add(VConfigUtility.buildColorConfigValue(builder, Visibilis.MOD_ID, "player", () -> VDataTypes.PLAYER, VUtility.toColor(84, 150, 231), VUtility.COLOR_DEFAULT_WHITE));
        this.list.add(VConfigUtility.buildColorConfigValue(builder, Visibilis.MOD_ID, "block_pos", () -> VDataTypes.BLOCK_POS, new float[] { 1F, 0.75F, 0.75F }, VUtility.COLOR_DEFAULT_BLACK));
        this.list.add(VConfigUtility.buildColorConfigValue(builder, Visibilis.MOD_ID, "world", () -> VDataTypes.WORLD, VUtility.toColor(38, 102, 180), VUtility.COLOR_DEFAULT_WHITE));
