...
public class VUtility
{
    ...
    /*
     * A Node's idx (index) is basically the in the list of the print. Using these positions, all connections can be numerically saved and read again. The only condition is that
     * you must load all connections before you modify any node positions. ... -> Modify Print -> Save Nodes -> Save Connections -> Load Nodes -> Load Connections -> Modify Print
     * -> ...
     */
