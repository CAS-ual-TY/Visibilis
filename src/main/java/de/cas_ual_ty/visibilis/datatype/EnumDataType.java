...
public class EnumDataType<A> extends DataType<A>
{
    /**
    ...
    public EnumDataType(ArrayFactory<A> arrayFactory)
    {
        super(arrayFactory);
     ...
     */
    public EnumDataType<A> addEnum(A value)
    {
        this.enums.add(value);
        return this;
    }
    ...
    {
        input.setValue(((EnumDataType<A>)input.getDataType()).getEnum(_enum));
    }
}
