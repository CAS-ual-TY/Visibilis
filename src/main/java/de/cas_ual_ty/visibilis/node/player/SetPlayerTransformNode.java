...
public class SetPlayerTransformNode extends Node
{
    ...
    public SetPlayerTransformNode(NodeType<?> type)
    {
        super(type);
        ...
        if(this.in3Vector3d.hasConnections() || this.in4Vector3d.hasConnections())
        {
            ...
            this.player.getServer().deferTask(() ->
            {
                ...
                if(this.in4Vector3d.hasConnections())
                {
                    ...
                    {
                        Visibilis.channel.send(PacketDistributor.PLAYER.with(() -> (ServerPlayerEntity)this.player), new PlayerMotionMessage(motion));
                    }
                }
            });
        }
