...
public abstract class NodeGenericXP2<A> extends NodeParallelizable
{
    ...
    protected abstract A calculate(A input, A in2); // Injective (Parallel)
    ...
    protected abstract A calculate(A[] inputs); // Not Injective
