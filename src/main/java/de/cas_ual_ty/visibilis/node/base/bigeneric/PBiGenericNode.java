...
public abstract class PBiGenericNode<O, I> extends ExpandableNode
{
    ...
    public PBiGenericNode(NodeType<?> type)
    {
        super(type);
    ...
    public static <O, I> NodeType.IFactory<PBiGenericNode<O, I>> createTypeBiGenericP(DataType<O> dataTypeOut, DataType<I> dataTypeIn, Function<I, O> function)
    {
        return PBiGenericNode.createTypeBiGenericP(dataTypeOut, dataTypeIn, function, (input) -> true);
    }
    
    public static <O, I> NodeType.IFactory<PBiGenericNode<O, I>> createTypeBiGenericP(DataType<O> dataTypeOut, DataType<I> dataTypeIn, Function<I, O> function, Function<I, Boolean> requirement)
    {
        return (type) ->
        {
            return new PBiGenericNode<O, I>(type)
            {
                @Override
