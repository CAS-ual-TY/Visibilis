...
public abstract class LoadVarGenericNode<A> extends Node
{
    ...
    public LoadVarGenericNode(NodeType<?> type)
    {
        super(type);
    ...
    public static <I> NodeType.IFactory<LoadVarGenericNode<I>> createTypeGenericLoadVar(DataType<I> dataType)
    {
        return (type) ->
        {
            return new LoadVarGenericNode<I>(type)
            {
                @Override
